...
- **Derived** (emitted by integrity components): `region_collapsing`. (`voxel_support_changed` was removed in Phase 6 with its only consumer, `CollapseDetector`; the never-emitted `part_support_changed` placeholder was removed in the 2026-06-09 cleanup.)
